<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Check-in.aspx.cs" Inherits="SportsToolsManagement.Check_in" %>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:HyperLink ID="HyperLink7" runat="server" class="text-decoration-none text-info" NavigateUrl="~/checkindetails.aspx">Select</asp:HyperLink></td>
                                            </tr>
                                            <%}
                                                }%>
                                        </tbody>
